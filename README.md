...
- 外部APIやトークンなしで試せるMockデモと、自動テスト41件。

問い合わせは受付文を返すデモです。問い合わせ本文の保存・担当者への通知は未実装です。AI回答生成、管理画面、CSV出力も含みません。
...
| 自動テスト | 2026-09-08、Python 3.12、既存34件＋異常系7件＝41件成功 |
...
Issue-driven workflow V1.1 test
